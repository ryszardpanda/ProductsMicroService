...
public class ProductsService {
    ...
    public ProductResponseDTO createProduct(ProductRequestDTO dto) {
        return setConfiguration(dto);
    }

    private ProductResponseDTO setConfiguration(ProductRequestDTO dto){
    ...
    public ProductResponseDTO updateProductById(Long id, ProductRequestDTO productRequestDTO) {
        ...
        createProduct(productRequestDTO, productEntity);
    ...
    private ProductEntity createProduct(ProductRequestDTO productRequestDTO, ProductEntity productEntity){
